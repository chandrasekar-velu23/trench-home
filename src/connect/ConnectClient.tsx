...
export default function ConnectClient() {
  ...
  const fade = (delay = 0) => ({
    initial: isInitialMount() ? false : { opacity: 0, y: 15 },
          ...
          >
            {isSuccess ? (
              <motion.div
                ...
                initial={isInitialMount() ? false : { opacity: 0, scale: 0.95 }}
              ...
              <>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div aria-hidden="true" style={{ position: "absolute", left: "-10000px", top: "auto", width: 1, height: 1, overflow: "hidden" }}>
                    <label htmlFor="connect-company-website">Leave this field empty</label>
                    <input type="text" id="connect-company-website" name="company_website" tabIndex={-1} autoComplete="off" defaultValue="" />
                  </div>
                  {/* Full Name */}
