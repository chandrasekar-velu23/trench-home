      ...
      <main style={{ backgroundColor: '#EDE7D9', minHeight: '100vh', position: 'relative', zIndex: 10, paddingBottom: '80px' }}>
        <div className="page-main overflow-hidden" style={{ backgroundColor: '#EDE7D9', paddingTop: '160px' }}>
          <div className="container-wide" style={{ maxWidth: '800px' }}>
            ...
            <Link href="/career" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', color: '#3152B9', fontWeight: 700, marginBottom: '2rem', textDecoration: 'none' }}>
            ...
            <ScrollReveal direction="up" delay={0.1} className="job-details-section">
              <p style={{ fontSize: '1.25rem', fontWeight: 600, color: '#000000', fontStyle: 'italic', borderLeft: '4px solid #3152B9', paddingLeft: '1.5rem', margin: '2rem 0' }}>
              ...
              <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid rgba(0,0,0,0.1)' }}>
                ...
                <p style={{ color: 'var(--color-neutral-600)', lineHeight: 1.6, marginBottom: '0', fontSize: '1.05rem' }}>
                  Ready to make the industry stop scrolling? Write to us not about yourself but why do you think you have fitment -<a href="mailto:career@trenchsecurity.ai?subject=Application for Product Marketing Intern" style={{ color: '#3152B9', fontWeight: 700, textDecoration: 'underline' }}>career@trenchsecurity.ai</a>.
                </p>
              </div>
            </ScrollReveal>
          </div>
