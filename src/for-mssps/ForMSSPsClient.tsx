              ...
              <>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div aria-hidden="true" style={{ position: "absolute", left: "-10000px", top: "auto", width: 1, height: 1, overflow: "hidden" }}>
                    <label htmlFor="mssp-company-website">Leave this field empty</label>
                    <input type="text" id="mssp-company-website" name="company_website" tabIndex={-1} autoComplete="off" defaultValue="" />
                  </div>
                  {/* Full Name */}
