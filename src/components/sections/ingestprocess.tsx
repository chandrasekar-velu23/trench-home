...
export default function IngestProcess() {
    ...
    // Brand palette only
    const P = "#3152B9";    // --color-primary-100
    const P2 = "#253D8F";    // --color-primary-200
    const PT = "#EDE7D9";    // light blue tint
    const PM = "#E4DCCB";    // mid blue tint
    const BG = "#ffffff";
    const BB = "#E4DCCB";    // --color-neutral-100
    const SC = "rgba(49, 82, 185, 0.12)";    // --color-neutral-200
    const TM = "#555555";    // --color-neutral-500
    const TD = "#2B2B2B";    // --color-neutral-700
        ...
        <div className="ingest-wrap">
            <svg viewBox="0 0 680 430" className="ingest-svg">
                ...
                {sources.map((s, i) => (
                    <g key={i}>
                        ...
                        <text x="46" y={s.y + 6} fontSize="11"
                            fill={pulse === i ? P : TD}
                            fontFamily="'Poppins', 'Poppins Fallback: Arial', 'Poppins Fallback: Roboto', sans-serif" fontWeight="700" letterSpacing="0.5">
                            {s.label}
                        </text>
                        {pulse === i && (
                ...
                <text x="275" y="102" textAnchor="middle" fontSize="11" fill={P}
                    fontFamily="'Poppins', 'Poppins Fallback: Arial', 'Poppins Fallback: Roboto', sans-serif" fontWeight="800" letterSpacing="1.5">
                    DATA ENGINE
                </text>
                {pipeline.map((step, i) => (
                    <g key={i}>
                        ...
                        <text x="274" y={146 + i * 58} textAnchor="middle" fontSize="11"
                            ...
                            fontFamily="'Poppins', 'Poppins Fallback: Arial', 'Poppins Fallback: Roboto', sans-serif" fontWeight="700" letterSpacing="1">
                            {step}
                        </text>
                        {i < 3 && (
                            <polygon
                ...
                <text x="532" y="122" textAnchor="middle" fontSize="11" fill={P}
                    fontFamily="'Poppins', 'Poppins Fallback: Arial', 'Poppins Fallback: Roboto', sans-serif" fontWeight="800" letterSpacing="1">
                    UNIFIED MESH
                </text>
