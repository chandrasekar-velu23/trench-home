...
/* ─────────────────────────────────────────
   ...
   ───────────────────────────────────────── */
const CATEGORIES = [
  { id: "all", label: "All", color: "#3152B9" },
  { id: "cloud", label: "Cloud", color: "#3152B9" },
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 40 40" fill="none" style={{ width: 36, height: 36 }}>
        <circle cx="20" cy="20" r="18" fill="#3152B9" fillOpacity="0.12" />
        <rect x="13" y="13" width="14" height="14" rx="3" stroke="#3152B9" strokeWidth="1.8" />
        <path d="M17 20h6M20 17v6" stroke="#3152B9" strokeWidth="1.8" strokeLinecap="round" />
      </svg>
    ),
  },
];
    ...
    <main className="page-main overflow-hidden">
      ...
      <div className="container-wide">
        ...
        <div className="int-hero">
          ...
          {/* <div style={{ width: '100%', maxWidth: '100%', height: 'auto', marginTop: '3rem', borderRadius: '16px', overflow: 'hidden' }}>
            <Image src="/integrations.webp" alt="Integrations Hero" width={1200} height={400} style={{ width: '100%', height: 'auto', display: 'block' }} priority />
          </div> */}
        </div>
