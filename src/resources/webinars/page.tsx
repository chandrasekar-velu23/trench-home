    ...
    <main className="resources-page overflow-hidden">
            ...
            <ScrollReveal key={item.id} direction="up" delay={i * 0.1}>
              <article className="webinar-card">
                ...
                <div className="webinar-embed-wrap">
                  <LiteYouTube id={item.youtubeId} title={item.title} fill priority={i === 0} />
                </div>
      ...
      <style>{`
        ...
        .webinar-card {
          ...
          border-radius: 20px;
          overflow: hidden;
          box-shadow: 0 4px 24px rgba(49, 82, 185, 0.04);
        ...
        .webinar-card:hover {
          ...
          box-shadow: 0 16px 48px rgba(49, 82, 185, 0.15);
          border-color: var(--color-primary-100, #3152B9);
        }
