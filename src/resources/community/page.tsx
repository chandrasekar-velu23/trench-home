        ...
        <div className="community-video-section" style={{ marginTop: "4rem", marginBottom: "4rem" }}>
          ...
          <ScrollReveal direction="up" delay={0.2} className="w-full">
            <div className="video-frame-wrapper">
              <LiteYouTube id="AEnT-jVCr-4" title="Trench BPL Founding Edition, BLR" fill />
            </div>
          </ScrollReveal>
        </div>
        ...
        <div style={{ marginTop: "6rem", marginBottom: "4rem" }}>
          ...
          <ScrollReveal direction="up" delay={0.2}>
            ...
            <div style={{ position: "relative", width: "100%", padding: "0 2rem", maxWidth: "1200px", margin: "0 auto" }}>
              <button 
                onClick={() => scroll('left')}
                style={{ position: "absolute", left: "-10px", top: "50%", transform: "translateY(-50%)", zIndex: 10, background: "var(--color-primary-100, #3152B9)", color: "white", borderRadius: "50%", width: "48px", height: "48px", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 16px rgba(49, 82, 185, 0.3)", cursor: "pointer", border: "none", transition: "transform 0.2s ease, background 0.2s ease" }}
                ...
                {[1, 2, 3, 4, 5, 6, 7].map((num) => (
                  <div key={num} className="resources-card" style={{ padding: "0.5rem", minWidth: "200px", width: "20vw", maxWidth: "280px", flexShrink: 0 }}>
                    <video 
                      ...
                      preload="none"
                      poster={`/BPL/optimized/posters/feedback-0${num}.jpg`} 
                      muted
              ...
              <button 
                ...
                style={{ position: "absolute", right: "-10px", top: "50%", transform: "translateY(-50%)", zIndex: 10, background: "var(--color-primary-100, #3152B9)", color: "white", borderRadius: "50%", width: "48px", height: "48px", display: "flex", alignItems: "center", justifyContent: "center", boxShadow: "0 4px 16px rgba(49, 82, 185, 0.3)", cursor: "pointer", border: "none", transition: "transform 0.2s ease, background 0.2s ease" }}
                onMouseEnter={(e) => (e.currentTarget.style.transform = "translateY(-50%) scale(1.1)")}
                onMouseLeave={(e) => (e.currentTarget.style.transform = "translateY(-50%) scale(1)")}
              >
        ...
        <div style={{ marginTop: "6rem", marginBottom: "4rem" }}>
          <ScrollReveal direction="up" className="text-center">
            <div className="event-calendar-card" style={{
              ...
              margin: "0 auto",
              textAlign: "center",
              boxShadow: "0 8px 32px rgba(49, 82, 185, 0.04)"
            }}>
