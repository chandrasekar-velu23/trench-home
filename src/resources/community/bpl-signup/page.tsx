  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch("/api/community-signup", {
        ...
        body: JSON.stringify({
          ...formData,
          company_website: (document.getElementById("bpl-company-website") as HTMLInputElement | null)?.value ?? "",
        }),
      });
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate>
                  ...
                  <div aria-hidden="true" style={{ position: "absolute", left: "-10000px", top: "auto", width: 1, height: 1, overflow: "hidden" }}>
                    <label htmlFor="bpl-company-website">Leave this field empty</label>
                    <input type="text" id="bpl-company-website" name="company_website" tabIndex={-1} autoComplete="off" defaultValue="" />
                  </div>
              <div
                style={{
                  display: "grid",
